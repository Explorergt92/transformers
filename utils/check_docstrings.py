...
def check_auto_docstrings(overwrite: bool = False, check_all: bool = False, use_cache: bool = True):
    """
...
if __name__ == "__main__":
    ...
    check_auto_docstrings(overwrite=args.fix_and_overwrite, check_all=args.check_all, use_cache=not args.no_cache)
